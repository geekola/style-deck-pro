    ...
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-950 px-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className={`w-full border rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white ${
                emailInvalid
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full border border-gray-200 dark:border-gray-700 rounded-lg pl-3 pr-10 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white"
                placeholder="********"
              />
              <button
                type="button"
                ...
                className="absolute inset-y-0 right-0 flex items-center px-3 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 rounded-r-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-black dark:focus-visible:ring-white focus-visible:ring-inset"
              >
                {showPassword ? (
        ...
        <p className="text-center text-sm text-gray-400 dark:text-gray-500 mt-6">
          <Link href="/forgot-password" className="underline underline-offset-2 hover:text-gray-600 dark:hover:text-gray-300">
            Forgot password?
          </Link>
        </p>
